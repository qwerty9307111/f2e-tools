...
const getElement = dom => isHTML(dom) ? dom : window.document
...
const disableSelect = (dom = window.document) => (getElement(dom).onselectstart = () => false)

const disableContextMenu = (dom = window.document) => (getElement(dom.oncontextmenu = () => false))

const disableCopy = (dom = window.document) => (getElement(dom).oncopy = () => false)

const replaceCopy = (str, dom = window.document) => {
