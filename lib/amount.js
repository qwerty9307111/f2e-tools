...
const number2Amount = _.curry((num, temp = '0,0', nullFormat = 'N/A', zeroFormat = 'N/A') => {
...
const number2ChineseWithOption = _.curry((option, amount) => {
  if (!_.isObject(option)) { throw new Error('param "option" type error') }
