export default [
  ...
  '定', '化', '莱', '校', '么', '抗', '祢', '綦', '悟', '宏', '功', '庚', '务', '敏', '捷', '拱', '丙', '游', '竺', '权',
  '逯', '盖', '益', '桓', '公', '称', '诺', '来', '多', '繁', '朴', '回', '毓', '鉏', '税', '荤', '靖', '赫', '实', '甫',
  '集', '象', '翠', '狂', '辟', '典', '良', '函', '芒', '苦', '其', '京', '中', '夕', '之', '召', '有', '舜', '丛', '岳',
  '寸', '二', '皇', '侨', '彤', '端', '竭', '冠', '宾', '香', '果', '蹇', '佟',
  '万俟', '司马', '上官', '欧阳', '夏侯', '诸葛', '闻人', '东方', '赫连', '皇甫', '尉迟', '公羊', '澹台', '公冶', '宗政', '濮阳',
  '淳于', '单于', '太叔', '申屠', '公孙', '仲孙', '轩辕', '令狐', '钟离', '宇文', '长孙', '慕容', '司徒', '司空', '章佳', '那拉',
  '纳喇', '乌雅', '范姜', '碧鲁', '张廖', '张简', '图门', '太史', '公叔', '乌孙', '完颜', '马佳', '佟佳', '富察', '费莫', '西门',
  '库雅喇', '瓜尔佳', '舒穆禄', '索绰络', '萨嘛喇', '赫舍里', '萨克达', '钮钴禄', '他塔喇', '喜塔腊',
  '爱新觉罗', '讷殷富察', '叶赫纳兰', '额尔德特', '依尔觉罗', '伊尔根觉罗'
]
